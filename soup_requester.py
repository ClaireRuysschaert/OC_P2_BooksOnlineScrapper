...
class BookScrapper:
    ...
    @classmethod
    def get_categories_name_url(cls) -> dict:
        """Get categories names and urls from home page."""

        categories_soup = cls.get_soup(cls.home_page_url).select(".nav-list a")
        categories_name_url = {}
    ...
    @classmethod
    def get_book_list_url(cls, category_url: str) -> list:
        """Get book's url list from a category url."""
        book_list_soup = cls.get_soup(category_url).findAll("h3")
        book_links = []
        ...
        while True:
            ...
            next_soup = cls.get_soup(category_url).select(".next a")
            if next_soup:
    ...
    @classmethod
    def get_book_informations(cls, book_url: str) -> tuple:
        ...
        detail_book_soup = cls.get_soup(book_url)
